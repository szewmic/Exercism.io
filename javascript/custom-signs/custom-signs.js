...
const calculateCost = (sign, basePrice = 20, letterCost = 2) => basePrice + (sign.length * letterCost);

export const costOf = (sign, currency) => `Your sign costs ${calculateCost(sign).toFixed(2)} ${currency}.`;
